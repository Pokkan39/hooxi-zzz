...
## 10. 特定批准记录：Mindscape Default 图包

> 批准日期：2026-07-27
> 作者：Toastertjie
> 原链接：https://steamcommunity.com/sharedfiles/filedetails/?id=3491187965

- 项目方明确确认已获得作者许可；批准范围仅限映射清单对应的 53 张 `Mindscape_*_Default.png`，不包括 Partial、Full、字体、脚本、项目文件、预览或图包中的其他内容。
- 允许在 HOOXI 内进行必要的本地化处理：resize、转换为 WebP，以及用于鼠标局部透彩效果的灰度交互；不得据此扩大为其他改作或再分发范围。
- 展示时必须保留作者 Toastertjie 与上述原始来源链接的署名记录。
- 收到作者或相关权利方的有效撤下请求时，先下线对应本地资产与展示，再核验并处理争议。
- 角色美术本身的版权归属与 HOOXI 的粉丝非官方边界保持不变。本记录只说明项目方确认获得该图包作者的许可，不表示或暗示米哈游、HoYoverse 或《绝区零》官方授权了该图包或 HOOXI。

## 11. 蕾米埃尔官方 Wiki 素材转换记录

- 现行 54 张 Default 由两类来源组成：第 10 节批准范围内的 53 张 Toastertjie 映射资产，以及 1 张蕾米埃尔 Default。蕾米埃尔不属于 Toastertjie 授权包，不得据第 10 节把 54 张 Default 统一标为已获该作者许可。
- 蕾米埃尔官方 Wiki 编号为 `2076`，英文名为 `REMIELLE`。card 与 portrait 来源为米哈游官方 Wiki 的 `display-1` 透明站姿；Default 来源为官方 `mindscape-1`。
- `display-1` 仅允许等比缩小后分别封装为 card 与完整透明 portrait；`mindscape-1` 仅允许等比缩小并居中封装到透明画布。转换不得裁切、放大、拉伸或抠图，也不得改变作品含义。
- 上述素材版权归米哈游；官方公开来源不等于开放授权。HOOXI 仅作粉丝非官方档案展示，必须保留官方 Wiki 来源、转换记录、版权归属与撤下边界。
- Stories / Character 使用 portrait；roster / avatar / headshot 使用 card。蕾米埃尔与达识结社的关系只按官方角色页佐证记录，独立阵营资料以及未确认的等级、属性、特性、攻击类型、实装日期、生日、专属音擎、CV 等均保持“待公布”。
